...
graph LR
    ...
    "scripts/capture-distributor-fixtures.py" --> "mouser_client.py"
...
- **Imports:** `browser_page.py`, `distributor_fixtures.py`, `mouser_client.py`
- **Imported by:** —
