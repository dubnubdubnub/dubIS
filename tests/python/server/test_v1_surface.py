...
_INVENTORY_API_METHOD_NAMES = {
    ...
    'enable_inventory_mirror', 'evaluate_part_predicates', 'exclude_generic_member', 'export_cart', 'extract_spec',
    ...
    'resolve_bom_spec', 'review_generic_member', 'rollback_source', 'save_file_dialog', 'save_preferences',
...
FROZEN_V1_SURFACE = [
    ...
    ("GET", "/v1/generic-parts/{generic_part_id}/reviews", "list_generic_member_reviews"),
    ...
    ("GET", "/v1/inventory-mirror", "get_inventory_mirror_info"),
    ("GET", "/v1/meta", "meta"),
    ...
    ("GET", "/v1/parts/{part_key}/attributes", "get_part_attributes"),
    ...
    ("POST", "/v1/generic-parts/{generic_part_id}/members/{part_id}/review", "review_generic_member"),
    ...
    ("POST", "/v1/inventory-mirror/disable", "disable_inventory_mirror"),
    ("POST", "/v1/inventory-mirror/enable", "enable_inventory_mirror"),
    ...
    ("PUT", "/v1/carts/{cart_id}/board-count", "set_cart_board_count"),
