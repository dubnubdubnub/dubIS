...
- `mfg-direct/mfg-direct-panel.js`: `beginScanImport`, `routeScanResult`, `startPhoneScan`, `editPO` — unified image/PDF OCR import (drag-drop, browse, and phone all converge here), phone-scan session, and PO editor entry points
